<?php
	...
	if(!empty($_POST))
	{
		...
		{
			$msg.="<li>Preencha todos os campos...";
		}
		
		if($_POST['pwd']!=$_POST['cpwd'])
		{
			$msg.="<li>Introduza a palavra passe novamente...";
		}
		
		if(!mb_ereg("^[a-z0-9_]+[a-z0-9_.]*@[a-z0-9_-]+[a-z0-9_.-]*\.[a-z]{2,5}$",$_POST['mail']))
		{
			$msg.="<li>Introduza um email valido...";
		}
